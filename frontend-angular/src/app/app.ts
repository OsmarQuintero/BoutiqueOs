...
export class App implements OnInit {
  get navItems(): ModuleStripItem[] {
    const all: ModuleStripItem[] = [
      ...
      {
        id: 'catalog',
        label: this.store.t('nav.catalog'),
        iconPath:
          'M4 7.5 12 4l8 3.5v9L12 20l-8-3.5zm8 1.64L6.5 6.73v7.04L12 16.18l5.5-2.41V6.73z',
      },
      {
        id: 'categories',
        label: this.store.t('nav.categories'),
        iconPath:
      ...
      {
        id: 'inventory',
        label: this.store.t('nav.inventory'),
        iconPath:
      ...
      {
        id: 'customers',
        label: this.store.t('nav.customers'),
        iconPath:
