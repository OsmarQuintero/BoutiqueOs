...
export const TRANSLATIONS: Record<string, TranslationEntry> = {
  ...
  'subscription.cancelConfirm': {
    es: '¿Cancelar tu suscripción? Sigues con todo hasta el fin del periodo que ya pagaste; después el sistema queda en solo lectura y puedes descargar tu respaldo.',
    en: 'Cancel your subscription? You keep everything until the end of the period you already paid; after that the system becomes read-only and you can download your backup.',
  },
  'subscription.cancelScheduled': {
    es: 'Listo: tu suscripción termina el {date}. Hasta entonces sigues con todo.',
    en: 'Done: your subscription ends on {date}. You keep everything until then.',
  },
  'subscription.cancelsOn': { es: 'Se cancela el {date}. Hasta entonces sigues con todo.', en: 'Cancels on {date}. You keep everything until then.' },
  'subscription.billedMonthly': { es: 'Pago mensual', en: 'Billed monthly' },
  'subscription.billedAnnual': { es: 'Pago anual', en: 'Billed yearly' },
  'subscription.interval': { es: 'Periodo de pago', en: 'Billing period' },
  'subscription.monthly': { es: 'Mensual', en: 'Monthly' },
  'subscription.annual': { es: 'Anual', en: 'Yearly' },
  'subscription.annualSave': { es: '2 meses gratis', en: '2 months free' },
  'subscription.perMonth': { es: 'Equivale a {amount}', en: 'Equals {amount}' },
  'subscription.recommended': { es: 'Recomendado', en: 'Recommended' },
  'subscription.manage': { es: 'Administrar suscripción', en: 'Manage subscription' },
  'subscription.manageHint': {
    es: 'Cambia de plan o a pago anual, actualiza tu tarjeta y descarga tus facturas en el portal seguro de Stripe.',
    en: 'Change plan or switch to yearly, update your card and download invoices in Stripe\'s secure portal.',
  },
  'subscription.switchPlan': { es: 'Cambiar a {plan}', en: 'Switch to {plan}' },
  'subscription.seats': { es: 'Usuarios de caja incluidos: {n}', en: 'Cashier users included: {n}' },
  'subscription.portalFailed': { es: 'No se pudo abrir el portal de pagos.', en: 'Could not open the billing portal.' },
  'billing.blocked': {
    es: 'Tu suscripción no está al corriente: el sistema está en solo lectura. Puedes consultar y descargar tu respaldo; para volver a vender, paga en Configuración > Suscripción.',
    en: 'Your subscription is not up to date: the system is read-only. You can browse and download your backup; to sell again, pay in Settings > Subscription.',
  },
  'billing.blockedCashier': {
    es: 'La suscripción de la tienda no está al corriente y no se puede vender. Avísale a la dueña.',
    en: 'The store subscription is not up to date and sales are paused. Let the owner know.',
  },
  'billing.grace': {
    es: 'No pudimos cobrar tu suscripción. Actualiza tu tarjeta antes del {date} para seguir vendiendo sin interrupciones.',
    en: 'We could not charge your subscription. Update your card before {date} to keep selling without interruption.',
  },
  'billing.goPay': { es: 'Ir a Suscripción', en: 'Go to Subscription' },
